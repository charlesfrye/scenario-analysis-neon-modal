...
class Remote(LazyMixin, IterableObj):
    ...
    def add_url(
        self, url: str, allow_unsafe_protocols: bool = False, **kwargs: Any
    ) -> "Remote":
        ...
        """
        return self.set_url(
            url, add=True, allow_unsafe_protocols=allow_unsafe_protocols
        )
    ...
    def pull(
        ...
        **kwargs: Any,
        ...
        if not allow_unsafe_options:
            Git.check_unsafe_options(
                options=list(kwargs.keys()), unsafe_options=self.unsafe_git_pull_options
            )
    ...
    def push(
        ...
        **kwargs: Any,
        ...
        if not allow_unsafe_options:
            Git.check_unsafe_options(
                options=list(kwargs.keys()), unsafe_options=self.unsafe_git_push_options
            )
